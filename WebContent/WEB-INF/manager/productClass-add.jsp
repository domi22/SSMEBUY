...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="index/classadd" method="post">
				<table class="form">
					<tr>
						...
						<td>
							<select name="fatherid">
								...
								<c:forEach items="${sessionScope.leftList}" var="good">
								     <c:if test="${good.fatherid==0}">
								        <option value="${good.goodid}">${good.goodname}</option>
								     </c:if>
								</c:forEach>
					...
					<tr>
						...
						<td><input type="text" class="text" name="goodname" value="子栏目" /></td>
					</tr>
					<tr>
						<td></td>
