...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改新闻</h2>
		<div class="manage">
			<form action="news/upd?currentPage=${requestScope.currentPage}&newid=${requestScope.mdfnew.newid}" method="post">
				<table class="form">
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="newtitle" value="${requestScope.mdfnew.newtitle}" /></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="content">${requestScope.mdfnew.content}</textarea></td>
					</tr>
					<tr>
						<td></td>
